...
void StudentWorld::setDisplayText() {
    ...
    int score = getScore();
    string s;
    s ="protestor :" + std::to_string(annoy) + " Scr: " + std::to_string(score)+ " Lvl: " + std::to_string(level) + " Lives: " + std::to_string(lives) + " Hlth: " + std::to_string(10 * health) + "% Wtr: " + std::to_string(squirts) + " Gld: " + std::to_string(gold) + " Oil Left: " + std::to_string(barrelsLeft) + " Sonar: " + std::to_string(sonar);
    setGameStatText(s);
}
int StudentWorld::move()
{
    ...
    if (tick == 1) {
        ...
        actorPtrs.push_back(new Protester(this, 60, 60, player));
        numProtesters++;
    }
